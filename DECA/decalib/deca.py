...
class DECA(nn.Module):
    ...
    # @torch.no_grad()
    def decode(self, codedict, device, rendering=True, iddict=None, vis_lmk=True, return_vis=True, use_detail=True):
        ...
        if self.cfg.model.use_tex:
            ...
            albedo = torch.zeros([batch_size, 3, self.uv_size, self.uv_size], device)
